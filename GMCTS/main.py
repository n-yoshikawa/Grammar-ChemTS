...
def current_best(scores):
    ...
    print("{},{},{},{},{},{},{},{}".format(elapsed_min, score, total, valid, good, unique_good, very_good, unique_very_good))
    t = threading.Timer(60, current_best, [scores])
    t.start()

def MCTS(rootstate, itermax=100):
...
def main():
    ...
    #train_rules = np.array(train_rules)
    #print("encoding finished. saving")
    #np.savez("rules.npz", train_rules)
    #print("rules saved")
    ...
    #                     optimizer.update()
    #    serializers.save_npz("model-{}.npz".format(epoch), rnn)
